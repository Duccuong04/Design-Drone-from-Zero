...
/*
 * Hàm này thực hiện lọc và tích phân gia tốc dọc (vertical acceleration) để tính toán sự
 * thay đổi độ cao (altitude variation) hoặc dùng trong việc ổn định drone.
 *
 * Short-term averaging (25 mẫu) → lọc nhiễu nhanh.
